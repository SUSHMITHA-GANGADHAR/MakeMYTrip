...
def populate():
    trips_data = [
        ...
        },
        {
            ...
            "duration": "3 Days / 2 Nights",
            "description": "Witness the world-famous Ganga Aarti and explore the narrow lanes of the world's oldest living city.",
            "price": 15000,
            "total_seats": 30,
            "available_seats": 20,
        ...
        },
        {
            ...
            "total_seats": 40,
            "available_seats": 40,
            "image_url": "https://images.unsplash.com/photo-1594991471329-87a710207399?w=1000",
        ...
        {
            "destination": "Luxury Bangalore to Mumbai",
            "duration": "1 Night / 1 Day",
            "description": "High-end sleeper coach service from the Silicon Valley of India to the City of Dreams.",
            "price": 19500,
            "total_seats": 30,
            "available_seats": 30,
            "image_url": "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=1000",
            "hotels": [],
            "nearby": "Mumbai Express"
        },
        {
        ...
        },
        {
            ...
            "duration": "7 Days / 6 Nights",
            "description": "Ultimate European getaway. Includes Eiffel Tower tours and Louvre visits.",
            "price": 45000,
            "total_seats": 20,
            "available_seats": 20,
